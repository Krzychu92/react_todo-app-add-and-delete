...
- Replace `<your_account>` with your Github username in the [DEMO LINK](https://krzychu92.github.io/react_todo-app-add-and-delete/) and add it to the PR description.
